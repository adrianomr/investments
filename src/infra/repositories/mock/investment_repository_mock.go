...
//
//	mockgen -source investment_repository.go -destination mock/investment_repository_mock.go -package mock
//
...
func (mr *MockInvestmentRepositoryMockRecorder) FindAll(ctx any) *gomock.Call {
